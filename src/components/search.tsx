  ...
  return (
    <div className="sticky top-0 flex items-start gap-2">
      <div className="flex-1 p-3 border rounded-xl bg-fd-card text-fd-card-foreground">
        <p className="text-sm font-medium mb-2">Ask Chronicle</p>
  ...
  return (
    <Context value={useMemo(() => ({ chat, open, setOpen }), [chat, open])}>
      ...
      <Presence present={open}>
        <div
          className={cn(
            'fixed flex flex-col inset-y-2 right-2 p-2 bg-fd-popover text-fd-popover-foreground border rounded-2xl shadow-lg z-30 sm:w-[460px] sm:end-2 max-sm:inset-x-2',
            open
