...
<Image
  ...
  alt="Male-female connectors showing series connection of components"
  width={400}
  height={300}
...
<Image
  src="/docimg/convert.jpg"
  alt="LED array circuit showing parallel connection with current-limiting resistors"
  width={400}
  height={300}
  className="rounded-lg shadow-md"
/>
