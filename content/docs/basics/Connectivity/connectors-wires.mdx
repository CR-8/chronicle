...
<Image
  src="/docimg/xt60.jpg"
  alt="XT60 power connectors showing male and female plugs"
  width={500}
  height={300}
...
<Image
  ...
  alt="Various types of jumper wires"
  width={500}
  height={300}
  className="rounded-lg shadow-md my-4"
/>
...
<Image
  src="/docimg/malefemale.jpg"
  alt="Male and female connector pins"
  width={500}
  height={300}
  className="rounded-lg shadow-md my-4"
/>
...
<Image
  src="/docimg/connector_convertor.jpg"
  alt="Connector converter boards"
  width={500}
  height={300}
  className="rounded-lg shadow-md my-4"
/>
...
<Callout type="info" title="Prototyping vs Production">
